...
const HealthCheckupLanding = () => {
  ...
  const handleCheckup = () => {
    console.log('Navigate to /checkup');
    navigate(`/checkup/${user}`);
  };
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'}`}>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button onClick={handleCheckup} className="bg-gradient-to-r from-blue-600 to-green-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:scale-105 hover:shadow-xl transition-all duration-300 flex items-center justify-center group">
                  Checkup
                  <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform duration-300" />
                </button>
                <button onClick={handleViewAnalysis}  className="border-2 border-blue-600 text-blue-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-blue-600 hover:text-white transition-all duration-300">
                  View Analysis
                </button>
              </div>
